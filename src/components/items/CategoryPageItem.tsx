  ...
  return (
    <div className="flex flex-col gap-8 lg:gap-0 lg:flex-row lg:items-center even:lg:flex-row-reverse even:lg:[&>div:first-child]:ml-[7.8125rem] odd:lg:[&>div:first-child]:mr-[7.8125rem]">
      ...
      <div className="text-center lg:text-left lg:basis-[45%]">
        <h2 className="uppercase text-[1.75rem] tracking-[0.0625rem] mb-6 max-w-[13ch] mx-auto lg:mx-0 font-bold">
          {isNew && (
        ...
        <p className="mb-6 px-0 sm:px-8 md:px-16 lg:px-0">{description}</p>

        <Link href={`/products/${category}/${slug}`}>
          <button className="bg-orange-500 text-white px-6 py-3 uppercase tracking-wider hover:bg-orange-600 transition">
            See Product
          </button>
        </Link>
      </div>
